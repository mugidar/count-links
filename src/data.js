export const testString = `Прямые эфиры привлекательны тем, что всё происходит в реальном времени, что позволяет полностью насладиться эмоциями, вызванными захватывающими и забавными моментами. Некоторые из них сегодня в нашей подборке.
